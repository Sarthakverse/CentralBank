...
import org.sarthak.accounts.dto.AccountsContactInfoDto;
...
@Tag(
        name = "CRUD REST APIs for Accounts in CentralBank",
        description = "CRUD REST APIs in CentralBank to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer and  Account inside CentralBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
