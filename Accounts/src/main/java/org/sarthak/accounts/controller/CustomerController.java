...
@Tag(
        name = "REST API for Customers in CentralBank",
        description = "REST APIs in CentralBank to FETCH customer details"
)
@RestController
...
public class CustomerController {
    ...
    public ResponseEntity<CustomerDetailsDto> fetchCustomerDetails(@RequestHeader("eazybank-correlation-id")
                                                                   ...
                                                                   @RequestParam @Pattern(regexp="(^$|[0-9]{10})",
                                                                       ...
                                                                       String mobileNumber){
        logger.debug("centrabank-correlation-id found: {} ", correlationId);
